...
await itsmevall.updatePresence(from, Presence.composing)
    ...
    const ownerNumber = [`6285741588880@s.whatsapp.net`]
...
const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `© ICIROBOT`,body:"",previewType:"PHOTO",thumbnail:bgg,sourceUrl:`https://wa.me/6285741588880?text=Hello bro`}}})
		}
    ...
    const ftroli = {
      key: {
        ...
        remoteJid: "6285741588880-1604595598@g.us",
      },
      message: {
        orderMessage: {
          itemCount: 10,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6285741588880-1616169743@g.us",
...
const fview = {
    ...
    const fvn = {
      key: {
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6285741588880-1613049930@g.us" } : {}),
      },
      message: {
        audioMessage: {
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "6285741588880-1613049930@g.us",
      "fromMe": false,
      ...
      itsmevall.sendMessage(from, teks, text, {
        quoted: {
          key: {
            fromMe: false,
            participant: `0@s.whatsapp.net`,
            ...(from ? { remoteJid: "6285741588880-1604595598@g.us" } : {}),
          },
          message: {
            imageMessage: {
              url: "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6285741588880-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FpE1TXXUzuk0TASzYwX8ZM', "groupName": `ICIROBOT-Bot Inc.`, "footerText": "*_© ICIROBOT_*", "jpgThumbnail": iye, "caption": teks}}, {quoted:mek})
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6285741588880`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6285741588880`,
                "thumbnailUrl": "https://k.top4top.io/p_20779elwn0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6285741588880`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6285741588880@s.whatsapp.net";
...
case 'help':
case 'menu':
       txtt =`${ucapanWaktu} *${pushname}*\n*Butuh bantuan?* Silahkan pakai Fitur yang ada di *ICIROBOT!*`
...
® ICIROBOT`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
buttons = [{buttonId:`${prefix}owner`,buttonText:{displayText: 'OWNER BOT'},type:1},{buttonId:`${prefix}ping`,buttonText:{displayText:'SPEED TEST'},type:1},{buttonId:`${prefix}rules`,buttonText:{displayText:'PERATURAN'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu1}`,
               footerText: `© 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 ICIROBOT
Fitur ini di Recode asli oleh ICIROBOTl!
...
break
      /*case "owner":
        sendKontak(from, owner, "ICIROBOT", "Busy");*/
             case 'setprofile':
			case 'setpp':
...
case 'owner':
           case 'creator':
               ...
               buttonsMessage = { contentText: `${haibg}`, footerText: '© ICIROBOT', buttons: buttons, headerType: 1 }
               prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
               itsmevall.relayWAMessage(prep)
               break      
              case 'dice':
...
break;
      ...
      //------------------< Group Features >-------------------
      case "listonline": //code by ICIROBOT
       ...
       case 'matpel':
         ...
         case 'rabu':
          ...
          case 'jumat':
              ...
              break
           case 'sabtu':
ruls =`*• ICIROBOT Menyatakan bahwa :*
...
case 'ytgw':
  reply('https://youtube.com/channel/UCpvZphb2Rcm_J-SzLnG7Srw/c/')
					break;
   case 'ss':
      reply(mess.wait)
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/DGICIROBOT"
        },
        "index": 0
      }
    ]
...
case "asupan3": // by ICIROBOT
  ...
  case 'write': case 'writeabook':            
            if (args.length == 0) return reply(`contoh: ${prefix + command} ICIROBOT`)
            reply(mess.wait)
            teks = args.join(" ")
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
		if (hour_now >= '02:00' && hour_now <= '04:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Subscribe ICIROBOT', 'yellow'), color('(🗿)', 'white'))
          }
        ...
        if (hour_now >= '06:00' && hour_now <= '11:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Susbcribe ICIROBOT', 'yellow'), color('(🗿)', 'white'))
          }
...
itsmevall.sendMessage(from, Peli, MessageType.sticker, {quoted: mek})
    ...
    if (isGroup && budy != undefined) {
      ...
      console.log(
        color("[SELFBOT]", "red"),
        "Self Bot By ICIROBOT",
        color(sender.split("@")[0])
      );
    }
   } catch (e) {
    e = String(e);// fixed fromMe by ICIROBOT
